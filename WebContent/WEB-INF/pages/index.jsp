...
<iframe id="main" name="main" class="ui-layout-center"
 ...
 <div style="background:url('${pageContext.request.contextPath}/css/images/bg.png');width:100%;height:100%;overflow:hidden;text-align:center;">
 <span style="color: #e6e6e6;font-family: serif;font-size: 40px;float:left;margin-left:40px;margin-top:20px;" >电力双视监控平台</span>
 <div style="float:right;text-align: right;">
	<div><span style="height: 20px;margin-right:20px;font-size: 20px;color:#121647;">当前站点:天星工作站</span></div>
